  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 text-slate-200 space-y-8">
      <div className="space-y-3 border-b border-slate-800 pb-8">
        ...
        <h1 className="font-serif text-4xl sm:text-5xl font-normal text-slate-100">Cookie Policy</h1>
      ...
      <div className="space-y-6 text-sm font-light text-slate-300 leading-relaxed">
        <h2 className="font-serif text-2xl text-slate-100 font-normal">1. Essential Cookies & Sessions</h2>
        <p>
          We use HTTP-only, secure session cookies to keep student driver portal logins secure and remember booking wizard progress.
        </p>

        <h2 className="font-serif text-2xl text-slate-100 font-normal">2. Third-Party Integrations</h2>
        <p>
