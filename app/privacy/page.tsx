  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 text-slate-200 space-y-8">
      <div className="space-y-3 border-b border-slate-800 pb-8">
        ...
        <h1 className="font-serif text-4xl sm:text-5xl font-normal text-slate-100">Privacy Policy</h1>
      ...
      <div className="space-y-6 text-sm font-light text-slate-300 leading-relaxed">
        <h2 className="font-serif text-2xl text-slate-100 font-normal">1. Information We Collect</h2>
        <p>
        ...
        <h2 className="font-serif text-2xl text-slate-100 font-normal">2. How We Use Your Information</h2>
        <p>
        ...
        <h2 className="font-serif text-2xl text-slate-100 font-normal">3. Data Security & Storage</h2>
        <p>
        ...
        <h2 className="font-serif text-2xl text-slate-100 font-normal">4. Contact Us</h2>
        <p>
