  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 text-slate-700 space-y-8">
      <div className="space-y-3 border-b border-slate-200 pb-8">
        ...
        <h1 className="font-serif text-4xl sm:text-5xl font-normal text-slate-900">Terms & Conditions</h1>
      ...
      <div className="space-y-6 text-sm font-light text-slate-600 leading-relaxed">
        <h2 className="font-serif text-2xl text-slate-900 font-normal">1. Driver Training Agreement</h2>
        <p>
        ...
        <h2 className="font-serif text-2xl text-slate-900 font-normal">2. Dual-Control Fleet Safety</h2>
        <p>
        ...
        <h2 className="font-serif text-2xl text-slate-900 font-normal">3. Cancellations & Rescheduling</h2>
        <p>
