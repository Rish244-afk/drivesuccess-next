...
const RAZORPAY_KEY_ID = process.env.RAZORPAY_KEY_ID || 'REDACTED_RAZORPAY_KEY';
const RAZORPAY_KEY_SECRET = process.env.RAZORPAY_KEY_SECRET || 'REDACTED_RAZORPAY_SECRET';
